...
from model.wide_residual_network import WideResidualNetworks
...
def main():
    ...
    model_name_default = "model_widenet" + today_date_str
    # get parameter
...
if __name__ == "__main__":
    print("start to train WideNetworks Model.")
    main()
    print("done")
